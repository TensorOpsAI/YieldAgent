...
export function ModelPicker({
  ...
  return (
    <div ref={ref} className="relative shrink-0">
      ...
      {open && (
        <div className="absolute bottom-full left-0 z-10 mb-1.5 w-60 overflow-hidden rounded-xl border border-line bg-surface shadow-[0_10px_30px_-12px_rgba(43,39,34,0.4)]">
          {models.length === 0 ? (
            ...
            models.map((m) => (
              ...
              >
                ...
                {m === value && <span className="ml-auto text-brand">✓</span>}
              </button>
            ))
          )}
        </div>
