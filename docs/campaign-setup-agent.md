...
Skips the gate. **Never combine with `YIELDAGENT_ALLOW_LIVE=1`** — auto-approve plus live accounts is exactly the failure mode the human gate exists to prevent.
